...
# Since app.add_middleware adds at the top of the stack and Starlette's routing happens inside FastAPI
app = FastAPI()
...
# To apply our pure ASGI middleware outside of FastAPI:
